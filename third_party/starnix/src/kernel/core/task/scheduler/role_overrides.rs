    ...
    pub fn get_role_name<'a>(
        ...
        for index in 0..self.process_filter.len() {
            if self.process_filter[index].is_match(process_name)
                ...
                && self.cgroup_filter[index]
                    .as_ref()
                    .map_or(true, |r| r.is_match(cgroup_path))
            {
...
mod tests {
    ...
    fn single_pattern() {
        ...
        assert_eq!(
            str_role_name(&mappings, "process_prefix_foo", "non_matching", "/"),
            None
        );
        assert_eq!(
            str_role_name(&mappings, "non_matching", "process_prefix_bar", "/"),
            None
        );
        assert_eq!(
            str_role_name(&mappings, "non_matching", "non_matching", "/"),
            None
        );
    }
    ...
    fn multiple_patterns() {
        ...
        assert_eq!(
            str_role_name(&mappings, "pre_one_foo", "non_matching", "/"),
            None
        );
        assert_eq!(
            str_role_name(&mappings, "non_matching", "pre_one_bar", "/"),
            None
        );
        assert_eq!(
            str_role_name(&mappings, "non_matching", "non_matching", "/"),
        ...
        assert_eq!(
            str_role_name(&mappings, "pre_two_foo", "non_matching", "/"),
            None
        );
        assert_eq!(
            str_role_name(&mappings, "non_matching", "pre_two_bar", "/"),
            None
        );
        ...
        assert_eq!(
            str_role_name(&mappings, "pre_three_foo", "non_matching", "/"),
            None
        );
        assert_eq!(
            str_role_name(&mappings, "non_matching", "pre_three_bar", "/"),
            None
        );
        ...
        assert_eq!(
            str_role_name(&mappings, "pre_four_foo", "non_matching", "/"),
            None
        );
        assert_eq!(
            str_role_name(&mappings, "non_matching", "pre_four_bar", "/"),
            None
        );
    }
    ...
    fn cgroup_patterns() {
        ...
        assert_eq!(
            str_role_name(&mappings, "proc", "thread", "/background"),
            Some("bg_role")
        );
        assert_eq!(
            str_role_name(&mappings, "proc", "thread", "/foreground"),
            Some("fg_role")
        );
        assert_eq!(
            str_role_name(&mappings, "proc", "thread", "/other"),
            Some("default_role")
        );
        assert_eq!(
            str_role_name(&mappings, "proc", "thread", "/"),
            Some("default_role")
        );
    }
}
