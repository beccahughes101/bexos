...
impl SocketFile {
    ...
    pub fn sendmsg(
        ...
        let mut op = || {
            ...
            let sent_bytes =
                self.socket
                    .write(current_task, data, &mut dest_address, &mut ancillary_data)?;
