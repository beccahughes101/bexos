...
impl AccessCheck {
    ...
    pub fn for_chdir() -> Self {
        Self {
            ...
            reason: CheckAccessReason::Chdir,
        }
    }
    ...
    pub fn for_chroot() -> Self {
        Self {
            permission_flags: PermissionFlags::EXEC,
            reason: CheckAccessReason::Chroot,
        }
    }
...
mod test {
    ...
    fn test_access_check() {
        ...
        assert_eq!(
            for_internal_access.permission_flags(),
            PermissionFlags::READ
        );
        assert_eq!(
            for_internal_access.reason(),
    ...
    fn test_open_access_check() {
        ...
        assert_eq!(
            from_flags.access_check().reason(),
            CheckAccessReason::InternalPermissionChecks
        );
        ...
        assert_eq!(
            skip_check.access_check().permission_flags(),
            PermissionFlags::empty()
        );
        assert_eq!(
            skip_check.access_check().reason(),
            CheckAccessReason::InternalPermissionChecks
        );
        ...
        assert_eq!(
            for_exec.access_check().permission_flags(),
            PermissionFlags::EXEC
        );
        ...
        assert_eq!(
            custom.access_check().permission_flags(),
            PermissionFlags::READ
        );
    }
}
