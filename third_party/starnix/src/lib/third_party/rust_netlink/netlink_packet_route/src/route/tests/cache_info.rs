...
use crate::route::{
    RouteAttribute, RouteCacheInfo, RouteHeader, RouteMessage, RouteMessageBuffer, RouteMetric,
...
fn test_ipv6_route_cache_info() {
    let raw = vec![
        ...
        0xfe, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd6, 0x38, 0x9c, 0xff, 0xfe, 0x01, 0xe8,
        0x52, // ipv6 addr
        0x08, 0x00, // length 8
        0x04, 0x00, // RTA_OIF 4
    ...
    let expected = RouteMessage {
        ...
        attributes: vec![
            ...
            RouteAttribute::Metrics(vec![RouteMetric::Mtu(1432), RouteMetric::Hoplimit(254)]),
