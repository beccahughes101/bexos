...
fn test_get_filter_u32() {
    let raw = vec![
        0x00, 0x00, 0x00, 0x00, 0x23, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x80, 0x00, 0x00, 0x01,
        0x00, 0x08, 0x00, 0x04, 0x00, 0x08, 0x00, 0x01, 0x00, 0x75, 0x33, 0x32, 0x00, 0x08, 0x00,
        0x0b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x74, 0x00, 0x02, 0x00, 0x34, 0x00, 0x05, 0x00, 0x01,
        0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0xff, 0xff, 0xff, 0xff, 0xc0, 0xa8, 0xbe, 0x07, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00, 0x8c, 0xa0, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x08, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x80, 0x08, 0x00, 0x01, 0x00, 0x04,
        0x00, 0x01, 0x00, 0x08, 0x00, 0x0b, 0x00, 0x08, 0x00, 0x00, 0x00, 0x24, 0x00, 0x09, 0x00,
            ...
            TcAttribute::Options(vec![
                TcOption::U32(TcFilterU32Option::Selector(TcU32Selector {
                    ...
                    keys: vec![
                        TcU32Key {
                            mask: 0xffffffff,
                            val: u32::from_ne_bytes(Ipv4Addr::new(192, 168, 190, 7).octets()),
                            off: 16,
                            offmask: 0,
                        },
                        TcU32Key {
                ...
                TcOption::U32(TcFilterU32Option::ClassId(TcHandle { major: 1, minor: 4 })),
                TcOption::U32(TcFilterU32Option::Flags(TcU32OptionFlags::NotInHw)),
...
fn test_tcu32_selector_invalid_nkeys() {
    ...
    assert!(TcU32SelectorBuffer::new(buffer).is_err());
}
