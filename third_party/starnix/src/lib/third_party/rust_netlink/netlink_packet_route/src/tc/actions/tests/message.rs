...
mod mirror {
    ...
    use crate::AddressFamily;
    use crate::tc::TcActionAttribute::{InHwCount, Kind, Options, Other, Stats};
    ...
    use crate::tc::actions::message::TcActionMessageAttribute::{Actions, RootCount};
    use crate::tc::actions::{TcActionMessageBuffer, TcActionMessageHeader};
    use crate::tc::{TcAction, TcActionGeneric, TcMirror, TcStatsBasic, TcStatsQueue};
    ...
    mod message {
        ...
        pub(super) const CREATE1: &[u8] = &[
            0x00, 0x00, 0x00, 0x00, 0x38, 0x00, 0x01, 0x00, 0x34, 0x00, 0x01, 0x00, 0x0b, 0x00,
            0x01, 0x00, 0x6d, 0x69, 0x72, 0x72, 0x65, 0x64, 0x00, 0x00, 0x24, 0x00, 0x02, 0x80,
            0x20, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00,
        ...
        pub(super) const CREATE2: &[u8] = &[
            0x00, 0x00, 0x00, 0x00, 0x38, 0x00, 0x01, 0x00, 0x34, 0x00, 0x01, 0x00, 0x0b, 0x00,
            0x01, 0x00, 0x6d, 0x69, 0x72, 0x72, 0x65, 0x64, 0x00, 0x00, 0x24, 0x00, 0x02, 0x80,
            0x20, 0x00, 0x02, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00,
        ...
        pub(super) const LIST: &[u8] = &[
            ,
        ];
                ...
                Actions(vec![
                    TcAction {
                        ...
                        attributes: vec![
                            ...
                            Other(DefaultNla::new(9, vec![0, 0, 0, 0, 3, 0, 0, 0])),
                            InHwCount(0),
                            Options(vec![
...
fn tc_action_message_flags_parse_back_example_value() {
    let orig = TcActionMessageFlagsWithSelector {
        flags: TcActionMessageFlags::LargeDump | TcActionMessageFlags::TerseDump,
...
fn tc_action_message_parse_back_example_value() {
    let orig = TcActionMessage {
        ...
        attributes: vec![
            ...
            TcActionMessageAttribute::Other(DefaultNla::new(99, vec![1, 2, 3, 4])),
        ],
    };
    let mut buffer = vec![0; orig.buffer_len()];
    orig.emit(&mut buffer);
