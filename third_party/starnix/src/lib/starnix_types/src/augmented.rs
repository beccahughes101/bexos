...
mod tests {
    ...
    fn test_transpose_option() {
        ...
        assert!(matches!(
            transposed_primary_some,
            Some(Augmented::<_, ()>::Primary(5))
        ));
        ...
        assert!(matches!(
            transposed_with_aux_some,
            Some(Augmented::WithAux(5, "hello"))
        ));
    ...
    fn test_transpose_result() {
        ...
        assert!(matches!(
            transposed_with_aux_ok,
            Ok(Augmented::WithAux(5, "hello"))
        ));
