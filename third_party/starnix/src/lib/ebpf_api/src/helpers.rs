...
fn bpf_probe_read_user_str<C: EbpfProgramContext>(
    ...
    track_stub!(
        TODO("https://fxbug.dev/534355539"),
...
fn bpf_ktime_get_coarse_ns<C: EbpfProgramContext>(
    ...
    track_stub!(
        TODO("https://fxbug.dev/534355976"),
...
fn bpf_get_smp_processor_id<C: EbpfProgramContext>(
    ...
    track_stub!(
        TODO("https://fxbug.dev/534354909"),
...
fn get_common_helpers<C: MapsProgramContext>() -> impl Iterator<Item = (u32, EbpfHelperImpl<C>)> {
    [
        (
            ...
            EbpfHelperImpl(bpf_ktime_get_boot_ns::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_ktime_get_coarse_ns,
            EbpfHelperImpl(bpf_ktime_get_coarse_ns::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_ktime_get_ns,
            EbpfHelperImpl(bpf_ktime_get_ns::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_map_delete_elem,
            EbpfHelperImpl(bpf_map_delete_elem::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_map_lookup_elem,
            EbpfHelperImpl(bpf_map_lookup_elem::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_map_update_elem,
            EbpfHelperImpl(bpf_map_update_elem::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_probe_read_str,
            EbpfHelperImpl(bpf_probe_read_str::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_probe_read_user,
            EbpfHelperImpl(bpf_probe_read_user::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_probe_read_user_str,
            EbpfHelperImpl(bpf_probe_read_user_str::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_ringbuf_discard,
            EbpfHelperImpl(bpf_ringbuf_discard::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_ringbuf_reserve,
            EbpfHelperImpl(bpf_ringbuf_reserve::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_ringbuf_submit,
            EbpfHelperImpl(bpf_ringbuf_submit::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_trace_printk,
            EbpfHelperImpl(bpf_trace_printk::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_get_smp_processor_id,
            EbpfHelperImpl(bpf_get_smp_processor_id::<C>),
        ),
    ]
    .into_iter()
}
...
-> impl Iterator<Item = (u32, EbpfHelperImpl<C>)> {
    [
        (
            ...
            EbpfHelperImpl(bpf_get_current_uid_gid::<C>),
        ),
        (
            bpf_func_id_BPF_FUNC_get_current_pid_tgid,
            EbpfHelperImpl(bpf_get_current_pid_tgid::<C>),
        ),
    ]
    .into_iter()
}
    ...
    fn get_helpers() -> HelperSet<Self> {
        [
            (
                ...
                EbpfHelperImpl(bpf_get_netns_cookie::<Self>),
            ),
            (
                bpf_func_id_BPF_FUNC_get_socket_cookie,
                EbpfHelperImpl(bpf_get_socket_cookie::<Self>),
            ),
            (
                bpf_func_id_BPF_FUNC_sk_storage_get,
                EbpfHelperImpl(bpf_sk_storage_get::<Self>),
            ),
            (
                bpf_func_id_BPF_FUNC_sk_lookup_tcp,
                EbpfHelperImpl(bpf_sk_lookup_tcp::<Self>),
            ),
            (
                bpf_func_id_BPF_FUNC_sk_lookup_udp,
                EbpfHelperImpl(bpf_sk_lookup_udp::<Self>),
            ),
            (
                bpf_func_id_BPF_FUNC_sk_release,
                EbpfHelperImpl(bpf_sk_release::<Self>),
            ),
        ]
        .into_iter()
    ...
    MapsProgramContext + CurrentTaskProgramContext + ReturnValueProgramContext + SkStorageProgramContext
{
    fn get_helpers() -> HelperSet<Self> {
        [
            ...
            (
                bpf_func_id_BPF_FUNC_set_retval,
                EbpfHelperImpl(bpf_set_retval::<Self>),
            ),
            (
                bpf_func_id_BPF_FUNC_get_retval,
                EbpfHelperImpl(bpf_get_retval::<Self>),
            ),
            (
                bpf_func_id_BPF_FUNC_sk_storage_get,
                EbpfHelperImpl(bpf_sk_storage_get::<Self>),
    ...
    fn get_helpers() -> HelperSet<Self> {
        vec![
            ...
            (
                ...
                EbpfHelperImpl(bpf_get_socket_uid::<Self>),
            ),
            (
                bpf_func_id_BPF_FUNC_get_socket_cookie,
                EbpfHelperImpl(bpf_get_socket_cookie::<Self>),
            ...
            (
                ...
                EbpfHelperImpl(bpf_skb_load_bytes::<Self>),
            ),
            (
                bpf_func_id_BPF_FUNC_skb_load_bytes_relative,
                EbpfHelperImpl(bpf_skb_load_bytes_relative::<Self>),
            ),
        ]
        .into_iter()
        .chain(get_common_helpers())
    ...
    fn get_helpers() -> HelperSet<Self> {
        vec![
            ...
            (
                ...
                EbpfHelperImpl(bpf_sk_fullsock::<Self>),
            ),
        ]
        .into_iter()
        .chain(get_common_helpers())
...
mod tests {
    ...
    fn test_probe_read_user_zeroes_destination() {
        ...
        assert_eq!(
            dst, [0u8; 8],
            "probe_read_user left the destination uninitialized"
        );
        ...
        assert_eq!(
            dst_str, [0u8; 8],
            "probe_read_user_str left the destination uninitialized"
        );
    }
}
