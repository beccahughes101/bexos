...
pub const SIGILL: Signal = Signal {
    number: uapi::SIGILL,
};
pub const SIGTRAP: Signal = Signal {
    number: uapi::SIGTRAP,
};
pub const SIGABRT: Signal = Signal {
    number: uapi::SIGABRT,
};
#[allow(dead_code)]
pub const SIGIOT: Signal = Signal {
    number: uapi::SIGIOT,
};
pub const SIGBUS: Signal = Signal {
    number: uapi::SIGBUS,
};
pub const SIGFPE: Signal = Signal {
    number: uapi::SIGFPE,
};
...
pub const SIGSEGV: Signal = Signal {
    number: uapi::SIGSEGV,
};
pub const SIGUSR2: Signal = Signal {
    number: uapi::SIGUSR2,
};
pub const SIGPIPE: Signal = Signal {
    number: uapi::SIGPIPE,
};
pub const SIGALRM: Signal = Signal {
    number: uapi::SIGALRM,
};
pub const SIGTERM: Signal = Signal {
    number: uapi::SIGTERM,
};
pub const SIGSTKFLT: Signal = Signal {
    number: uapi::SIGSTKFLT,
};
pub const SIGCHLD: Signal = Signal {
    number: uapi::SIGCHLD,
};
...
pub const SIGTSTP: Signal = Signal {
    number: uapi::SIGTSTP,
};
pub const SIGTTIN: Signal = Signal {
    number: uapi::SIGTTIN,
};
pub const SIGTTOU: Signal = Signal {
    number: uapi::SIGTTOU,
};
pub const SIGURG: Signal = Signal {
    number: uapi::SIGURG,
};
pub const SIGXCPU: Signal = Signal {
    number: uapi::SIGXCPU,
};
pub const SIGXFSZ: Signal = Signal {
    number: uapi::SIGXFSZ,
};
pub const SIGVTALRM: Signal = Signal {
    number: uapi::SIGVTALRM,
};
pub const SIGPROF: Signal = Signal {
    number: uapi::SIGPROF,
};
pub const SIGWINCH: Signal = Signal {
    number: uapi::SIGWINCH,
};
pub const SIGIO: Signal = Signal {
    number: uapi::SIGIO,
};
pub const SIGPWR: Signal = Signal {
    number: uapi::SIGPWR,
};
pub const SIGSYS: Signal = Signal {
    number: uapi::SIGSYS,
};
#[allow(dead_code)]
pub const SIGRTMIN: Signal = Signal {
    number: super::SIGRTMIN,
};
