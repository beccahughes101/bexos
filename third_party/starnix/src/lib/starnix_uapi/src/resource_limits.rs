...
use crate::{
    ...
    RLIMIT_RTPRIO, RLIMIT_RTTIME, RLIMIT_SIGPENDING, RLIMIT_STACK, rlimit, uapi,
};
...
const INFINITE_LIMIT: rlimit = rlimit {
    rlim_cur: RLIM_INFINITY as u64,
    rlim_max: RLIM_INFINITY as u64,
};
...
const DEFAULT_LIMITS: [(Resource, rlimit); 9] = [
    ...
    (
        ...
        rlimit {
            rlim_cur: 0,
            rlim_max: uapi::RLIM_INFINITY as u64,
        },
    ),
    (
        Resource::NPROC,
    ...
    (
        Resource::NOFILE,
        rlimit {
            rlim_cur: uapi::INR_OPEN_CUR as u64,
            rlim_max: uapi::INR_OPEN_MAX as u64,
        },
    ),
    (
        Resource::MEMLOCK,
        rlimit {
            rlim_cur: uapi::MLOCK_LIMIT as u64,
            rlim_max: uapi::MLOCK_LIMIT as u64,
        },
    ),
    (
        Resource::SIGPENDING,
        rlimit {
            rlim_cur: SIGPENDING_LIMIT,
            rlim_max: SIGPENDING_LIMIT,
        },
    ),
    (
        Resource::MSGQUEUE,
        rlimit {
            rlim_cur: uapi::MQ_BYTES_MAX as u64,
            rlim_max: uapi::MQ_BYTES_MAX as u64,
        },
    ),
    (
        Resource::NICE,
