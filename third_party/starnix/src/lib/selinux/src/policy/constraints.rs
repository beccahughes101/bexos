...
pub(super) fn evaluate_constraint(
    ...
    debug_assert!(
        stack.is_empty(),
        "validated term sequence leaves stack empty"
    );
    result
}
...
mod tests {
    ...
    fn evaluate_constraint_expr() {
        ...
        let class_constraint_eq = classes
            .get_by_name(b"class_constraint_eq")
        ...
        let class_constraint_with_and = classes
            .get_by_name(b"class_constraint_with_and")
            .expect("look up class");
        ...
        let class_constraint_with_not = classes
            .get_by_name(b"class_constraint_with_not")
            .expect("look up class");
        ...
        let class_constraint_with_names = classes
            .get_by_name(b"class_constraint_with_names")
            .expect("look up class");
        ...
        let class_constraint_nested = classes
            .get_by_name(b"class_constraint_nested")
            .expect("look up class");
        ...
        assert_eq!(
            evaluate_constraint(constraint_nested, &source, &target),
            true
        );

        let class_constraint_role_names = classes
            .get_by_name(b"class_constraint_role_names")
            .expect("look up class");
        ...
        assert_eq!(
            evaluate_constraint(constraint_role_names, &source, &target),
            true
        );

        let class_constraint_type_names = classes
            .get_by_name(b"class_constraint_type_names")
            .expect("look up class");
        ...
        assert_eq!(
            evaluate_constraint(constraint_type_names, &source, &target),
            true
        );

        let class_constraint_type_list = classes
            .get_by_name(b"class_constraint_type_list")
            .expect("look up class");
        ...
        assert_eq!(
            evaluate_constraint(constraint_type_list, &source, &target),
            true
        );
    }
    ...
    fn evaluate_mls_constraint_expr() {
        ...
        let classes = policy.classes();
        let class = classes
            .get_by_name(b"class_mls_constraints")
            .expect("look up class");
