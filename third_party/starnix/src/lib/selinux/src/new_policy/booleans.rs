...
mod tests {
    ...
    fn test_conditional_boolean_parse_and_serialize() {
        ...
        boolean
            ...
            .expect("serialize ConditionalBoolean");
    ...
    fn test_conditional_booleans() {
        ...
        let first = booleans
            .get_by_name(b"test_cond_first")
            .expect("test_cond_first");
        assert!(first.active());

        let second = booleans
            .get_by_name(b"test_cond_second")
            .expect("test_cond_second");
        assert!(!second.active());

        let third = booleans
            .get_by_name(b"test_cond_third")
            .expect("test_cond_third");
        assert!(third.active());
    }
}
