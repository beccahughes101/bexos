...
pub enum ValidateError {
    ...
    #[error("invalid extended permissions type: {value}")]
    InvalidExtendedPermissionsType { value: u8 },
    #[error(
    ...
    InvalidExtensibleBitmapHighBit {
        found_size: u32,
        found_high_bit: u32,
        found_count: u32,
    },
    ...
    MisalignedExtensibleBitmapHighBit {
        found_size: u32,
        found_high_bit: u32,
    },
    #[error(
    ...
    MisalignedExtensibleBitmapItemStartBit {
        found_start_bit: u32,
        found_size: u32,
    },
    #[error(
    ...
    OutOfOrderExtensibleBitmapItems {
        found_start_bit: u32,
        min_start: u32,
    },
